...
function acquireR(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield exec.exec("sudo", ["installer", "-pkg", "/tmp/R-latest.pkg", "-target", "/"]);
        }
        catch (error) {
            core.debug(error);
...
function setupRLibrary() {
    return __awaiter(this, void 0, void 0, function* () {
        yield fs_1.promises.writeFile(path.join(process.env['HOME'] || '/Users', '.Rprofile'), 'options(repos = "https://cloud.r-project.org")');
    });
}
